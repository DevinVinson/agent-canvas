...
export default [
  layout("routes/root-layout.tsx", [
    ...
    route("automate", "routes/automations-hub.tsx"),
    route("automations", "routes/automations-list.tsx"),
    route("automations/workflows", "routes/automation-workflows.tsx"),
    route("automations/routines", "routes/automation-routines.tsx"),
    route("automations/responders", "routes/automation-responders.tsx"),
    route("automations/templates", "routes/automation-templates.tsx"),
    route("automations/presets", "routes/automation-presets.tsx"),
